...
namespace Oefening1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            lijstAdressen.Add(1, ad1);
            lijstAdressen.Add(2, ad2);
            cp1.Addresses = lijstAdressen;

            Console.WriteLine("Adressen...");
            foreach (var item in lijstAdressen)
            {
                Console.WriteLine(item.ToString());
                //Address a = (Address)item;
                //Console.Write(" - - - " + a.Street);
            }

            Address a1= new Address();
            List<ContactPerson> cpen = new List<ContactPerson>();
            cpen.Add(cp1);
            ...
            al.Sort();
            Console.WriteLine("2de waarde:  {0}", al[1]);
            Console.WriteLine("1ste waarde:  {0}", al[0]);
